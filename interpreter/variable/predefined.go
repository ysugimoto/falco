...
const (
	...
	FASTLY_BOT_ANALYZED                               = "fastly.bot.analyzed"
	FASTLY_BOT_CATEGORY                               = "fastly.bot.category"
	FASTLY_BOT_CATEGORY_IS_ACCESSIBILITY              = "fastly.bot.category.is_accessibility"
	FASTLY_BOT_CATEGORY_IS_AI_CRAWLER                 = "fastly.bot.category.is_ai_crawler"
	FASTLY_BOT_CATEGORY_IS_AI_FETCHER                 = "fastly.bot.category.is_ai_fetcher"
	FASTLY_BOT_CATEGORY_IS_CONTENT_FETCHER            = "fastly.bot.category.is_content_fetcher"
	FASTLY_BOT_CATEGORY_IS_MONITORING_AND_SITE_TOOLS  = "fastly.bot.category.is_monitoring_and_site_tools"
	FASTLY_BOT_CATEGORY_IS_ONLINE_MARKETING           = "fastly.bot.category.is_online_marketing"
	FASTLY_BOT_CATEGORY_IS_PAGE_PREVIEW               = "fastly.bot.category.is_page_preview"
	FASTLY_BOT_CATEGORY_IS_PLATFORM_INTEGRATIONS      = "fastly.bot.category.is_platform_integrations"
	FASTLY_BOT_CATEGORY_IS_RESEARCH                   = "fastly.bot.category.is_research"
	FASTLY_BOT_CATEGORY_IS_SEARCH_ENGINE_CRAWLER      = "fastly.bot.category.is_search_engine_crawler"
	FASTLY_BOT_CATEGORY_IS_SEARCH_ENGINE_OPTIMIZATION = "fastly.bot.category.is_search_engine_optimization"
	FASTLY_BOT_CATEGORY_IS_SECURITY_TOOLS             = "fastly.bot.category.is_security_tools"
	FASTLY_BOT_CATEGORY_IS_VERIFIED                   = "fastly.bot.category.is_verified"
	FASTLY_BOT_DETECTED                               = "fastly.bot.detected"
	FASTLY_BOT_NAME                                   = "fastly.bot.name"
