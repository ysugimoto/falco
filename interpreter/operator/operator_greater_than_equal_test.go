...
func TestGreaterThanEqualOperator(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Integer{Value: 1000}, right: &value.Integer{Value: 1}, expect: true},
			{left: &value.Integer{Value: 1000}, right: &value.Integer{Value: 1, Literal: true}, expect: true},
			...
			{left: &value.Integer{Value: 1000}, right: &value.RTime{Value: 1 * time.Second}, expect: true},
		...
		for i, tt := range tests {
			v, err := GreaterThanEqual(tt.left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Float{Value: 1000.0}, right: &value.Integer{Value: 10}, expect: true},
			{left: &value.Float{Value: 1000.0}, right: &value.Integer{Value: 10, Literal: true}, expect: true},
			{left: &value.Float{Value: 1000.0}, right: &value.Float{Value: 10.0}, expect: true},
			{left: &value.Float{Value: 1000.0}, right: &value.Float{Value: 10.0, Literal: true}, expect: true},
			...
			{left: &value.Float{Value: 1000.0}, right: &value.RTime{Value: 1 * time.Second}, expect: true},
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.RTime{Value: 100 * time.Second}, right: &value.Integer{Value: 10}, expect: true},
			{left: &value.RTime{Value: 100 * time.Second}, right: &value.Integer{Value: 10, Literal: true}, isError: true},
			{left: &value.RTime{Value: 100 * time.Second}, right: &value.Float{Value: 10.0}, expect: true},
			...
			{left: &value.RTime{Value: 100 * time.Second}, right: &value.RTime{Value: time.Second}, expect: true},
			{left: &value.RTime{Value: 100 * time.Second}, right: &value.RTime{Value: time.Second, Literal: true}, expect: true},
	...
	t.Run("left is TIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Time{Value: now.Add(1 * time.Second)}, right: &value.Time{Value: now}, expect: true},
			{left: &value.Time{Value: now}, right: &value.Time{Value: now}, expect: true},
			{left: &value.Time{Value: now}, right: &value.Time{Value: now.Add(1 * time.Second)}, expect: false},
