...
func TestLogicalOrOperator(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Integer{Value: 10}, right: &value.String{Value: ""}, isError: true},
			{left: &value.Integer{Value: 10}, right: &value.String{IsNotSet: true}, isError: true},
		...
		for i, tt := range tests {
			v, err := LogicalOr(tt.left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Float{Value: 10.0}, right: &value.String{Value: ""}, isError: true},
			{left: &value.Float{Value: 10.0}, right: &value.String{IsNotSet: true}, isError: true},
	...
	t.Run("left is STRING", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.String{Value: "example"}, right: &value.String{Value: ""}, expect: true},
			{left: &value.String{Value: "example"}, right: &value.String{Value: "", Literal: true}, isError: true},
			{left: &value.String{Value: "example"}, right: &value.String{Value: ""}, expect: true},
			{left: &value.String{Value: "example"}, right: &value.String{IsNotSet: true}, expect: true},
			...
			{left: &value.String{Value: "example"}, right: &value.Boolean{Value: false, Literal: true}, expect: true},
			...
			{left: &value.String{Value: ""}, right: &value.Integer{Value: 10}, isError: true},
			{left: &value.String{Value: ""}, right: &value.Integer{Value: 10, Literal: true}, isError: true},
			{left: &value.String{Value: ""}, right: &value.Float{Value: 10.0}, isError: true},
			{left: &value.String{Value: ""}, right: &value.Float{Value: 10.0, Literal: true}, isError: true},
			{left: &value.String{Value: ""}, right: &value.String{Value: "example"}, expect: true},
			{left: &value.String{Value: ""}, right: &value.String{Value: "example", Literal: true}, isError: true},
			{left: &value.String{Value: ""}, right: &value.String{Value: ""}, expect: true},
			{left: &value.String{Value: ""}, right: &value.String{IsNotSet: true}, expect: true},
			{left: &value.String{Value: ""}, right: &value.RTime{Value: 100 * time.Second}, isError: true},
			{left: &value.String{Value: ""}, right: &value.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: &value.String{Value: ""}, right: &value.Time{Value: now}, isError: true},
			{left: &value.String{Value: ""}, right: &value.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: &value.String{Value: ""}, right: &value.Boolean{Value: true}, expect: true},
			{left: &value.String{Value: ""}, right: &value.Boolean{Value: false, Literal: true}, expect: true},
			...
			{left: &value.String{Value: ""}, right: &value.String{Value: "example"}, expect: true},
			{left: &value.String{IsNotSet: true}, right: &value.String{Value: "example"}, expect: true},
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.RTime{Value: time.Second}, right: &value.String{Value: ""}, isError: true},
			{left: &value.RTime{Value: time.Second}, right: &value.String{IsNotSet: true}, isError: true},
	...
	t.Run("left is TIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Time{Value: now}, right: &value.String{Value: ""}, isError: true},
			{left: &value.Time{Value: now}, right: &value.String{IsNotSet: true}, isError: true},
	...
	t.Run("left is BACKEND", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Backend{Value: backend}, right: &value.String{Value: ""}, isError: true},
			{left: &value.Backend{Value: backend}, right: &value.String{IsNotSet: true}, isError: true},
	...
	t.Run("left is BOOL", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Boolean{Value: true}, right: &value.String{Value: "example"}, expect: true},
			{left: &value.Boolean{Value: true}, right: &value.String{Value: "example", Literal: true}, isError: true},
			{left: &value.Boolean{Value: true}, right: &value.String{Value: ""}, expect: true},
			{left: &value.Boolean{Value: true}, right: &value.String{Value: "", Literal: true}, isError: true},
			{left: &value.Boolean{Value: true}, right: &value.String{IsNotSet: true}, expect: true},
			...
			{left: &value.Boolean{Value: true}, right: &value.Boolean{Value: false}, expect: true},
			{left: &value.Boolean{Value: true}, right: &value.Boolean{Value: false, Literal: true}, expect: true},
			{left: &value.Boolean{Value: true}, right: &value.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
			{left: &value.Boolean{Value: true, Literal: true}, right: &value.Boolean{Value: false}, expect: true},
			{left: &value.Boolean{Value: true, Literal: true}, right: &value.Boolean{Value: false, Literal: true}, expect: true},
		}
	...
	t.Run("left is IP", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.IP{Value: v}, right: &value.String{Value: ""}, isError: true},
			{left: &value.IP{Value: v}, right: &value.String{IsNotSet: true}, isError: true},
