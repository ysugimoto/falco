...
func TestEqualOperator(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Integer{Value: 10}, right: &value.Integer{Value: 10}, expect: true},
			{left: &value.Integer{Value: 10}, right: &value.Integer{Value: 10, Literal: true}, expect: true},
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Float{Value: 10.0}, right: &value.Float{Value: 10.0}, expect: true},
			{left: &value.Float{Value: 10.0}, right: &value.Float{Value: 10.0, Literal: true}, expect: true},
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.RTime{Value: time.Second}, right: &value.RTime{Value: time.Second}, expect: true},
			{left: &value.RTime{Value: time.Second}, right: &value.RTime{Value: time.Second, Literal: true}, expect: true},
	...
	t.Run("left is BACKEND", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Backend{Value: backend}, right: &value.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, expect: true},
	...
	t.Run("left is IP", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.IP{Value: v}, right: &value.IP{Value: net.ParseIP("127.0.0.1")}, expect: true},
		}
