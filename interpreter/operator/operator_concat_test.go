...
func TestConcatOperator(t *testing.T) {
	...
	t.Run("left is STRING", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.String{Value: "example"}, right: &value.String{IsNotSet: true}, expect: "example(null)"},
			...
			{left: &value.String{Value: "example"}, right: &value.IP{IsNotSet: true}, expect: "example(null)"},
	...
	t.Run("left is IP", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.IP{Value: v}, right: &value.String{IsNotSet: true}, expect: "127.0.0.1(null)"},
			...
			{left: &value.IP{Value: v}, right: &value.IP{IsNotSet: true}, expect: "127.0.0.1(null)"},
		}
