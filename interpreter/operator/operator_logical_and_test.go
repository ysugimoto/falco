...
func TestLogicalAndOperator(t *testing.T) {
	...
	t.Run("left is STRING", func(t *testing.T) {
		...
		tests := []struct {
			...
			// Could not use string literal in expression
			...
			// Empty string should be true, only be false on notset
			{left: &value.String{Value: "example"}, right: &value.String{Value: ""}, expect: true},
			{left: &value.String{Value: "example"}, right: &value.String{IsNotSet: true}, expect: false},
			...
			{left: &value.String{Value: "example"}, right: &value.Boolean{Value: false, Literal: true}, expect: false},
			...
			{left: &value.String{IsNotSet: true}, right: &value.String{Value: ""}, expect: false},
			{left: &value.String{IsNotSet: true}, right: &value.String{IsNotSet: true}, expect: false},
			{left: &value.String{Value: ""}, right: &value.String{Value: "", Literal: true}, isError: true},
			...
			{left: &value.String{Value: ""}, right: &value.Boolean{Value: false, Literal: true}, expect: false},
	...
	t.Run("left is BOOL", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Boolean{Value: true}, right: &value.String{IsNotSet: true}, isError: false},
			...
			{left: &value.Boolean{Value: true}, right: &value.Boolean{Value: true}, expect: true},
			{left: &value.Boolean{Value: true}, right: &value.Boolean{Value: true, Literal: true}, expect: true},
