...
func TestLogicalAndOperator(t *testing.T) {
	...
	t.Run("left is STRING", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.String{Value: "example"}, right: &value.String{Value: ""}, expect: false},
			...
			{left: &value.String{Value: ""}, right: &value.String{Value: "example"}, expect: false},
			...
			{left: &value.String{Value: ""}, right: &value.Boolean{Value: true}, expect: false},
	...
	t.Run("left is BOOL", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &value.Boolean{Value: true}, right: &value.String{Value: ""}, expect: false},
