...
func Test_Math_acosh(t *testing.T) {
	...
	tests := []struct {
		...
		{input: &value.Float{Value: 0.5}, expect: &value.Float{IsNAN: true}, err: &value.String{Value: "EDOM"}},
		{input: &value.Float{Value: 1.2}, expect: &value.Float{Value: 0.6223625037147786}, err: nil},
	}

	for i, tt := range tests {
		ret, err := Math_acosh(&context.Context{}, tt.input)
		if err != nil {
