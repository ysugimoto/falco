...
func Test_Math_cosh(t *testing.T) {
	tests := []struct {
		...
		{input: &value.Float{IsNegativeInf: true}, expect: &value.Float{IsPositiveInf: true}, err: nil},
		...
		{input: &value.Float{Value: 0.5}, expect: &value.Float{Value: 1.1276259652063807}, err: nil},
	}

	for i, tt := range tests {
		ret, err := Math_cosh(&context.Context{}, tt.input)
		if err != nil {
