...
func TestProcessSubtraction(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 10, right: &value.Integer{Value: 100}, expect: -90},
			{left: 10, right: &value.Integer{Value: 100, Literal: true}, expect: -90},
			{left: 10, right: &value.Float{Value: 50.0}, expect: -40.0},
			...
			{left: 10, right: &value.RTime{Value: 100 * time.Second}, expect: -90},
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 10.0, right: &value.Integer{Value: 100}, expect: -90.0},
			{left: 10.0, right: &value.Integer{Value: 100, Literal: true}, expect: -90.0},
			{left: 10, right: &value.Float{Value: 50.0}, expect: -40.0},
			{left: 10, right: &value.Float{Value: 50.0, Literal: true}, expect: -40.0},
			{left: 10, right: &value.String{Value: "example"}, isError: true},
			{left: 10, right: &value.String{Value: "example", Literal: true}, isError: true},
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: time.Second, right: &value.Integer{Value: 100}, expect: -99 * time.Second},
			{left: time.Second, right: &value.Integer{Value: 100, Literal: true}, isError: true},
			{left: time.Second, right: &value.Float{Value: 50.0}, expect: -49 * time.Second},
			...
			{left: time.Second, right: &value.RTime{Value: 100 * time.Second}, expect: -99 * time.Second},
			{left: time.Second, right: &value.RTime{Value: 100 * time.Second, Literal: true}, expect: -99 * time.Second},
