...
func TestProcessDivision(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 1000, right: &value.Integer{Value: 100}, expect: 10},
			{left: 1000, right: &value.Integer{Value: 100, Literal: true}, expect: 10},
			{left: 1000, right: &value.Float{Value: 50.0}, expect: 20},
			{left: 1000, right: &value.Float{Value: 50.0, Literal: true}, isError: true},
			{left: 1000, right: &value.String{Value: "example"}, isError: true},
			{left: 1000, right: &value.String{Value: "example", Literal: true}, isError: true},
			{left: 1000, right: &value.RTime{Value: 100 * time.Second}, isError: true},
			{left: 1000, right: &value.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: 1000, right: &value.Time{Value: now}, isError: true},
			{left: 1000, right: &value.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: 1000, right: &value.Boolean{Value: true}, isError: true},
			{left: 1000, right: &value.Boolean{Value: false, Literal: true}, isError: true},
			{left: 1000, right: &value.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
		}

		for i, tt := range tests {
			left := &value.Integer{Value: tt.left}
			err := Division(left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 1000.0, right: &value.Integer{Value: 100}, expect: 10.0},
			{left: 1000.0, right: &value.Integer{Value: 100, Literal: true}, expect: 10.0},
			{left: 1000.0, right: &value.Float{Value: 50.0}, expect: 20.0},
			{left: 1000.0, right: &value.Float{Value: 50.0, Literal: true}, expect: 20.0},
			{left: 1000.0, right: &value.String{Value: "example"}, isError: true},
			{left: 1000.0, right: &value.String{Value: "example", Literal: true}, isError: true},
			{left: 1000.0, right: &value.RTime{Value: 100 * time.Second}, isError: true},
			{left: 1000.0, right: &value.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: 1000.0, right: &value.Time{Value: now}, isError: true},
			{left: 1000.0, right: &value.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: 1000.0, right: &value.Boolean{Value: true}, isError: true},
			{left: 1000.0, right: &value.Boolean{Value: false, Literal: true}, isError: true},
			{left: 1000.0, right: &value.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
		}
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 100 * time.Second, right: &value.Integer{Value: 100}, expect: 1 * time.Second},
			{left: 100 * time.Second, right: &value.Integer{Value: 100, Literal: true}, expect: 1 * time.Second},
			{left: 100 * time.Second, right: &value.Float{Value: 50.0}, expect: 2 * time.Second},
			{left: 100 * time.Second, right: &value.Float{Value: 50.0, Literal: true}, expect: 2 * time.Second},
			{left: 100 * time.Second, right: &value.String{Value: "example"}, isError: true},
			{left: 100 * time.Second, right: &value.String{Value: "example", Literal: true}, isError: true},
			{left: 100 * time.Second, right: &value.RTime{Value: 100 * time.Second}, isError: true},
			{left: 100 * time.Second, right: &value.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: 100 * time.Second, right: &value.Time{Value: now}, isError: true},
			{left: 100 * time.Second, right: &value.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: 100 * time.Second, right: &value.Boolean{Value: true}, isError: true},
			{left: 100 * time.Second, right: &value.Boolean{Value: false, Literal: true}, isError: true},
			{left: 100 * time.Second, right: &value.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
		}
