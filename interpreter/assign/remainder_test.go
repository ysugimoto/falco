...
func TestProcessRemainder(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 1002, right: &value.Integer{Value: 100}, expect: 2},
			{left: 1002, right: &value.Integer{Value: 100, Literal: true}, expect: 2},
			{left: 1002, right: &value.Float{Value: 50.0}, expect: 2},
			{left: 1002, right: &value.Float{Value: 50.0, Literal: true}, isError: true},
			{left: 1002, right: &value.String{Value: "example"}, isError: true},
			{left: 1002, right: &value.String{Value: "example", Literal: true}, isError: true},
			{left: 1002, right: &value.RTime{Value: 100 * time.Second}, isError: true},
			{left: 1002, right: &value.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: 1002, right: &value.Time{Value: now}, isError: true},
			{left: 1002, right: &value.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: 1002, right: &value.Boolean{Value: true}, isError: true},
			{left: 1002, right: &value.Boolean{Value: false, Literal: true}, isError: true},
			{left: 1002, right: &value.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
		}

		for i, tt := range tests {
			left := &value.Integer{Value: tt.left}
			err := Remainder(left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 1002.0, right: &value.Integer{Value: 100}, expect: 2.0},
			{left: 1002.0, right: &value.Integer{Value: 100, Literal: true}, expect: 2.0},
			{left: 1002.0, right: &value.Float{Value: 50.0}, expect: 2.0},
			{left: 1002.0, right: &value.Float{Value: 50.0, Literal: true}, expect: 2.0},
			{left: 1002.0, right: &value.String{Value: "example"}, isError: true},
			{left: 1002.0, right: &value.String{Value: "example", Literal: true}, isError: true},
			{left: 1002.0, right: &value.RTime{Value: 100 * time.Second}, isError: true},
			{left: 1002.0, right: &value.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: 1002.0, right: &value.Time{Value: now}, isError: true},
			{left: 1002.0, right: &value.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: 1002.0, right: &value.Boolean{Value: true}, isError: true},
			{left: 1002.0, right: &value.Boolean{Value: false, Literal: true}, isError: true},
			{left: 1002.0, right: &value.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
		}
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 1002 * time.Second, right: &value.Integer{Value: 100}, expect: 2 * time.Second},
			{left: 1002 * time.Second, right: &value.Integer{Value: 100, Literal: true}, expect: 2 * time.Second},
			{left: 1002 * time.Second, right: &value.Float{Value: 50.0}, expect: 2 * time.Second},
			{left: 1002 * time.Second, right: &value.Float{Value: 50.0, Literal: true}, expect: 2 * time.Second},
			{left: 1002 * time.Second, right: &value.String{Value: "example"}, isError: true},
			{left: 1002 * time.Second, right: &value.String{Value: "example", Literal: true}, isError: true},
			{left: 1002 * time.Second, right: &value.RTime{Value: 100 * time.Second}, isError: true},
			{left: 1002 * time.Second, right: &value.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: 1002 * time.Second, right: &value.Time{Value: now}, isError: true},
			{left: 1002 * time.Second, right: &value.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: 1002 * time.Second, right: &value.Boolean{Value: true}, isError: true},
			{left: 1002 * time.Second, right: &value.Boolean{Value: false, Literal: true}, isError: true},
			{left: 1002 * time.Second, right: &value.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
		}
