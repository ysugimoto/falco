...
| linter.rules.[rule_name]                | String              | -           | -                  | Override linter error level for the rule name, see [rules](https://github.com/ysugimoto/falco/blob/main/docs/rules.md)             |
...
| format                                  | Object              | null        | -                  | Formatter configuration object                                                                                                        |
| format.indent_width                     | Integer             | 2           | --indent_width     | Indent width                                                                                                                          |
| format.indent_style                     | String              | space       | --indent_style     | Indent style, `space` or `tab`                                                                                                        |
| format.trailing_comment_width           | Integer             | 1           | --trailing_comment_width | Trailing comment space size                                                                                                      |
| format.line_width                       | Integer             | 120         | --line_width       | Max line width, `-1` to disable                                                                                                       |
| format.explicit_string_concat           | Boolean             | true        | --explicit_string_concat | Use explicit `+` for string concatenation                                                                                        |
| format.sort_declaration_property        | Boolean             | false       | --sort_declaration_property | Sort declaration properties alphabetically                                                                                    |
| format.align_declaration_property       | Boolean             | false       | --align_declaration_property | Align declaration properties                                                                                                 |
| format.else_if                          | Boolean             | false       | --else_if          | Coerce `else if` keyword                                                                                                              |
| format.always_next_line_else_if         | Boolean             | false       | --always_next_line_else_if | Print `else`/`else if` on next line                                                                                           |
| format.return_statement_parenthesis     | Boolean             | true        | --return_statement_parenthesis | Wrap return ident in parenthesis                                                                                           |
| format.sort_declaration                 | Boolean             | false       | --sort_declaration | Sort root declarations by directive order                                                                                             |
| format.align_trailing_comment           | Boolean             | false       | --align_trailing_comment | Align trailing comments                                                                                                          |
| format.comment_style                    | String              | none        | --comment_style    | Comment style, `sharp` or `slash`                                                                                                     |
| format.should_use_unset                 | Boolean             | false       | --should_use_unset | Replace `remove` with `unset`                                                                                                         |
| format.indent_case_labels               | Boolean             | false       | --indent_case_labels | Indent case labels in switch                                                                                                        |
| format.break_compound_conditions        | Boolean             | false       | --break_compound_conditions | Break compound conditions into multiple lines                                                                                 |
