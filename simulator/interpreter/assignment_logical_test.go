...
func TestProcessLogicalOR(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 10, right: &variable.Integer{Value: 1}, isError: true},
			{left: 10, right: &variable.Integer{Value: 1, Literal: true}, isError: true},
			{left: 10, right: &variable.Float{Value: 50.0}, isError: true},
			...
			{left: 10, right: &variable.RTime{Value: 100 * time.Second}, isError: true},
			{left: 10, right: &variable.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: 10, right: &variable.Time{Value: now}, isError: true},
		...
		for i, tt := range tests {
			...
			err := ip.ProcessLogicalORAssignment(left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: 10.0, right: &variable.Integer{Value: 100}, isError: true},
			{left: 10.0, right: &variable.Integer{Value: 100, Literal: true}, isError: true},
			{left: 10.0, right: &variable.Float{Value: 50.0}, isError: true},
			{left: 10.0, right: &variable.Float{Value: 50.0, Literal: true}, isError: true},
			{left: 10.0, right: &variable.String{Value: "example"}, isError: true},
			{left: 10.0, right: &variable.String{Value: "example", Literal: true}, isError: true},
			{left: 10.0, right: &variable.RTime{Value: 100 * time.Second}, isError: true},
			{left: 10.0, right: &variable.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: 10.0, right: &variable.Time{Value: now}, isError: true},
			{left: 10.0, right: &variable.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: 10.0, right: &variable.Boolean{Value: true}, isError: true},
			{left: 10.0, right: &variable.Boolean{Value: false, Literal: true}, isError: true},
			{left: 10.0, right: &variable.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
		}
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: time.Second, right: &variable.Integer{Value: 100}, isError: true},
			{left: time.Second, right: &variable.Integer{Value: 100, Literal: true}, isError: true},
			{left: time.Second, right: &variable.Float{Value: 50.0}, isError: true},
			...
			{left: time.Second, right: &variable.RTime{Value: 100 * time.Second}, isError: true},
			{left: time.Second, right: &variable.RTime{Value: 100 * time.Second, Literal: true}, isError: true},
			{left: time.Second, right: &variable.Time{Value: now}, isError: true},
...
func TestProcessLogicalAND(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		now := time.Now()
		tests := []struct {
			left    int64
			...
			{left: 10, right: &variable.Integer{Value: 32}, isError: true},
			{left: 10, right: &variable.Integer{Value: 32, Literal: true}, isError: true},
			{left: 10, right: &variable.Float{Value: 50.0}, isError: true},
			{left: 10, right: &variable.Float{Value: 50.0, Literal: true}, isError: true},
			{left: 10, right: &variable.String{Value: "example"}, isError: true},
			{left: 10, right: &variable.String{Value: "example", Literal: true}, isError: true},
		...
		for i, tt := range tests {
			ip := New(nil)
			left := &variable.Integer{Value: tt.left}
			err := ip.ProcessLogicalANDAssignment(left, tt.right)
			if tt.isError {
				if err == nil {
					t.Errorf("Index %d: expects error but non-nil", i)
				}
	...
	t.Run("left is BOOL", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: false, right: &variable.Time{Value: now}, isError: true},
			{left: false, right: &variable.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: false, right: &variable.Boolean{Value: true}, isError: false},
			{left: false, right: &variable.Boolean{Value: true, Literal: true}, isError: false},
			{left: false, right: &variable.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
		}
