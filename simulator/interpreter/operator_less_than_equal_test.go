...
func TestLessThanEqualOperator(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Integer{Value: 1000}, right: &variable.Integer{Value: 1}, expect: false},
			{left: &variable.Integer{Value: 1000}, right: &variable.Integer{Value: 1, Literal: true}, expect: false},
			{left: &variable.Integer{Value: 1000}, right: &variable.Float{Value: 10.0}, isError: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.Float{Value: 10.0, Literal: true}, isError: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.String{Value: "example"}, isError: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.String{Value: "example", Literal: true}, isError: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.RTime{Value: 1 * time.Second}, expect: false},
			{left: &variable.Integer{Value: 1000}, right: &variable.RTime{Value: 1 * time.Second, Literal: true}, isError: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.Time{Value: now}, isError: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.Boolean{Value: true}, isError: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.Boolean{Value: false, Literal: true}, isError: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
			{left: &variable.Integer{Value: 1000, Literal: true}, right: &variable.Integer{Value: 100}, isError: true},
			{left: &variable.Integer{Value: 1000, Literal: true}, right: &variable.Integer{Value: 100, Literal: true}, isError: true},
		}

		for i, tt := range tests {
			ip := New(nil)
			v, err := ip.ProcessLessThanEqualOperator(tt.left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Float{Value: 1000.0}, right: &variable.Integer{Value: 10}, expect: false},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Integer{Value: 10, Literal: true}, expect: false},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Float{Value: 10.0}, expect: false},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Float{Value: 10.0, Literal: true}, expect: false},
			{left: &variable.Float{Value: 1000.0}, right: &variable.String{Value: "example"}, isError: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.String{Value: "example", Literal: true}, isError: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.RTime{Value: 1 * time.Second}, expect: false},
			{left: &variable.Float{Value: 1000.0}, right: &variable.RTime{Value: 1 * time.Second, Literal: true}, isError: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Time{Value: now}, isError: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Boolean{Value: true}, isError: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Boolean{Value: false, Literal: true}, isError: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
			{left: &variable.Float{Value: 1000.0, Literal: true}, right: &variable.Integer{Value: 100}, isError: true},
			{left: &variable.Float{Value: 1000.0, Literal: true}, right: &variable.Integer{Value: 100, Literal: true}, isError: true},
		}
	...
	t.Run("left is STRING", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "example"}, isError: true},
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "example", Literal: true}, isError: true},
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Integer{Value: 10}, expect: false},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Integer{Value: 10, Literal: true}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Float{Value: 10.0}, expect: false},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Float{Value: 10.0, Literal: true}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.String{Value: "example"}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.String{Value: "example", Literal: true}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.RTime{Value: time.Second}, expect: false},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.RTime{Value: time.Second, Literal: true}, expect: false},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Time{Value: now}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Boolean{Value: true}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Boolean{Value: false, Literal: true}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second, Literal: true}, right: &variable.Integer{Value: 100}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second, Literal: true}, right: &variable.Integer{Value: 100, Literal: true}, isError: true},
		}
	...
	t.Run("left is TIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Time{Value: now}, right: &variable.Time{Value: now}, isError: true},
	...
	t.Run("left is BACKEND", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Backend{Value: backend}, right: &variable.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, isError: true},
	...
	t.Run("left is BOOL", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Boolean{Value: true}, right: &variable.Boolean{Value: true}, isError: true},
			{left: &variable.Boolean{Value: true}, right: &variable.Boolean{Value: true, Literal: true}, isError: true},
	...
	t.Run("left is IP", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.IP{Value: v}, right: &variable.IP{Value: net.ParseIP("127.0.0.1")}, isError: true},
		}
