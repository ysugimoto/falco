...
func TestEqualOperator(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Integer{Value: 10}, right: &variable.Integer{Value: 10}, expect: true},
			{left: &variable.Integer{Value: 10}, right: &variable.Integer{Value: 10, Literal: true}, expect: true},
		...
		for i, tt := range tests {
			ip := New(nil)
			v, err := ip.ProcessEqualOperator(tt.left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Float{Value: 10.0}, right: &variable.Float{Value: 10.0}, expect: true},
			{left: &variable.Float{Value: 10.0}, right: &variable.Float{Value: 10.0, Literal: true}, expect: true},
	...
	t.Run("left is STRING", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "example"}, expect: true},
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "example", Literal: true}, expect: true},
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.RTime{Value: time.Second}, right: &variable.RTime{Value: time.Second}, expect: true},
			{left: &variable.RTime{Value: time.Second}, right: &variable.RTime{Value: time.Second, Literal: true}, expect: true},
	...
	t.Run("left is TIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Time{Value: now}, right: &variable.Time{Value: now}, expect: true},
	...
	t.Run("left is BACKEND", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Backend{Value: backend}, right: &variable.Backend{Value: &ast.BackendDeclaration{Name: &ast.Ident{Value: "foo"}}}, expect: true},
	...
	t.Run("left is BOOL", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Boolean{Value: true}, right: &variable.Boolean{Value: true}, expect: true},
			{left: &variable.Boolean{Value: true}, right: &variable.Boolean{Value: true, Literal: true}, expect: true},
	...
	t.Run("left is IP", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.IP{Value: v}, right: &variable.IP{Value: net.ParseIP("127.0.0.1")}, expect: true},
		}
