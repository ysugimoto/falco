...
func TestNotRegexOperator(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Integer{Value: 10}, right: &variable.Integer{Value: 10}, isError: true},
		...
		for i, tt := range tests {
			ip := New(nil)
			v, err := ip.ProcessNotRegexOperator(tt.left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Float{Value: 10.0}, right: &variable.Float{Value: 10.0}, isError: true},
	...
	t.Run("left is STRING", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "amp"}, expect: false},
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "^++a"}, isError: true}, // invalid regex syntax
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "amp", Literal: true}, expect: false},
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "^++a", Literal: true}, isError: true}, // invalid regex syntax
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.RTime{Value: time.Second}, right: &variable.RTime{Value: time.Second}, isError: true},
	...
	t.Run("left is IP", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.IP{Value: v}, right: &variable.Acl{Value: acl}, expect: false},
		}
