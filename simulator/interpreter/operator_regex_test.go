...
func TestRegexOperator(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		for i, tt := range tests {
			ip := New(nil)
			v, err := ip.ProcessRegexOperator(tt.left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is STRING", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "amp"}, expect: true},
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "^++a"}, isError: true}, // invalid regex syntax
			{left: &variable.String{Value: "example"}, right: &variable.String{Value: "amp", Literal: true}, expect: true},
	...
	t.Run("left is IP", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.IP{Value: v}, right: &variable.Acl{Value: acl}, expect: true},
		}
