...
func TestGreaterThanEqualOperator(t *testing.T) {
	t.Run("left is INTEGER", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Integer{Value: 1000}, right: &variable.Integer{Value: 1}, expect: true},
			{left: &variable.Integer{Value: 1000}, right: &variable.Integer{Value: 1, Literal: true}, expect: true},
			...
			{left: &variable.Integer{Value: 1000}, right: &variable.RTime{Value: 1 * time.Second}, expect: true},
		...
		for i, tt := range tests {
			ip := New(nil)
			v, err := ip.ProcessGreaterThanEqualOperator(tt.left, tt.right)
			if tt.isError {
				if err == nil {
	...
	t.Run("left is FLOAT", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.Float{Value: 1000.0}, right: &variable.Integer{Value: 10}, expect: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Integer{Value: 10, Literal: true}, expect: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Float{Value: 10.0}, expect: true},
			{left: &variable.Float{Value: 1000.0}, right: &variable.Float{Value: 10.0, Literal: true}, expect: true},
			...
			{left: &variable.Float{Value: 1000.0}, right: &variable.RTime{Value: 1 * time.Second}, expect: true},
	...
	t.Run("left is RTIME", func(t *testing.T) {
		...
		tests := []struct {
			...
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Integer{Value: 10}, expect: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Integer{Value: 10, Literal: true}, isError: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.Float{Value: 10.0}, expect: true},
			...
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.RTime{Value: time.Second}, expect: true},
			{left: &variable.RTime{Value: 100 * time.Second}, right: &variable.RTime{Value: time.Second, Literal: true}, expect: true},
