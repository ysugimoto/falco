...
func assert_test(t *testing.T, v value.Value, suite testSuite, name string) {
	ret, err := Assert_equal(&context.Context{}, v, suite.compare)
	if diff := cmp.Diff(
		suite.err,
		err,
		...
		t.Errorf("Assert_equal()[%s] error: diff=%s", name, diff)
	}
	if diff := cmp.Diff(ret, &value.Boolean{Value: suite.expect}); diff != "" {
		t.Errorf("Assert_equal()[%s] return value mismatch: diff=%s", name, diff)
	}
}
...
func Test_Assert_equal(t *testing.T) {
	...
	t.Run("NULL", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is NULL")
		}
	})
	...
	t.Run("INTEGER", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is INTEGER")
		}
	})
	...
	t.Run("FLOAT", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is FLOAT")
		}
	})
	...
	t.Run("STRING", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is STRING")
		}
	})
	...
	t.Run("BOOL", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is BOOLEAN")
		}
	})
	...
	t.Run("RTIME", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is RTIME")
		}
	})
	...
	t.Run("TIME", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is TIME")
		}
	})
	...
	t.Run("IP", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is IP")
		}
	})
	...
	t.Run("BACKEND", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is BACKEND")
		}
	})
	...
	t.Run("ACL", func(t *testing.T) {
		...
		for i := range tests {
			assert_test(t, v, tests[i], "Actual is ACL")
		}
	})
}
