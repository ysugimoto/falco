...
- fix(simulate): prevent response headers from appearing as body in proxy mode [#580](https://github.com/ysugimoto/falco/pull/580) (@3846masa)
- fix: error on bare infix expression in BOOL declare assignment [#578](https://github.com/ysugimoto/falco/pull/578) (@acme)
- feat: support += string concatenation for all string variables [#576](https://github.com/ysugimoto/falco/pull/576) (@acme)
- Add fastly.ff.last_hop_was_serviceid built-in function [#574](https://github.com/ysugimoto/falco/pull/574) (@jedisct1)
- Set default client.ip for testing and console modes [#572](https://github.com/ysugimoto/falco/pull/572) (@bungoume)
- Fix broken links in docs [#571](https://github.com/ysugimoto/falco/pull/571) (@bungoume)
- Coerce string override to IP type for IP variables [#570](https://github.com/ysugimoto/falco/pull/570) (@bungoume)
- add testcase for override_host and fix it [#567](https://github.com/ysugimoto/falco/pull/567) (@morbidick)
- feat(formatter): add break_compound_conditions option [#564](https://github.com/ysugimoto/falco/pull/564) (@acme)
- fix(formatter): correct blank line placement around leading comments in blocks [#563](https://github.com/ysugimoto/falco/pull/563) (@acme)
- fix: correct typos in tests and comments [#562](https://github.com/ysugimoto/falco/pull/562) (@acme)
- Fix: synthetic after restart causes segfault [#560](https://github.com/ysugimoto/falco/pull/560) (@akrainiouk)
- fix: correct spelling typos in generator and interpreter [#559](https://github.com/ysugimoto/falco/pull/559) (@acme)
- docs: update contributors list [#558](https://github.com/ysugimoto/falco/pull/558) (@acme)
- Add testing.return_value to access functional subroutine results [#557](https://github.com/ysugimoto/falco/pull/557) (@jedisct1)
- Fix simulator JSON error field serialization [#555](https://github.com/ysugimoto/falco/pull/555) (@jedisct1)
- Fix flaky TIME concatenation test race condition [#554](https://github.com/ysugimoto/falco/pull/554) (@jedisct1)
- Fix regsub panic on non-participating capture groups [#553](https://github.com/ysugimoto/falco/pull/553) (@jedisct1)
- implement bereq.fetch_timeout predefined variable [#550](https://github.com/ysugimoto/falco/pull/550) (@ysugimoto)
- fix tests, linting [#549](https://github.com/ysugimoto/falco/pull/549) (@ysugimoto)
- strftime: %0 is a valid padding modifier [#546](https://github.com/ysugimoto/falco/pull/546) (@jedisct1)
- std.anystr2ip: add IPv6 support [#545](https://github.com/ysugimoto/falco/pull/545) (@jedisct1)
- Fix utf8_* functions [#544](https://github.com/ysugimoto/falco/pull/544) (@jedisct1)
- Fix random_* functions [#543](https://github.com/ysugimoto/falco/pull/543) (@jedisct1)
- Fix math functions [#542](https://github.com/ysugimoto/falco/pull/542) (@jedisct1)
- Make digest_hmac_* functions return NULL with an empty key [#541](https://github.com/ysugimoto/falco/pull/541) (@jedisct1)
- feat(linter): infer subroutine scope from call graph analysis [#540](https://github.com/ysugimoto/falco/pull/540) (@acme)
- fix(linter): make h2.push second argument optional [#539](https://github.com/ysugimoto/falco/pull/539) (@acme)
- fix(types): correct req.protocol type from BOOL to STRING [#538](https://github.com/ysugimoto/falco/pull/538) (@acme)
- fix(linter): lint value expressions in declare statements [#537](https://github.com/ysugimoto/falco/pull/537) (@acme)
- fix(testing): apply fixed_access_rate to ratelimit.ratecounter_increment [#536](https://github.com/ysugimoto/falco/pull/536) (@bungoume)
- fix(formatter): format closer to official Fastly format [#534](https://github.com/ysugimoto/falco/pull/534) (@acme)
- fix(formatter): correct typos in code and comments [#533](https://github.com/ysugimoto/falco/pull/533) (@acme)
- vcl: Fix typos [#532](https://github.com/ysugimoto/falco/pull/532) (@acme)
- docs: fix typos across documentation and changelog [#531](https://github.com/ysugimoto/falco/pull/531) (@acme)
- Stringify backends and boolean literals [#530](https://github.com/ysugimoto/falco/pull/530) (@akrainiouk)
- Fix linting for functions with both positional and variadic args [#529](https://github.com/ysugimoto/falco/pull/529) (@MasonM)
